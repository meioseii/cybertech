<HTML>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="table_inbound.css">
...
$transdate = $_POST['transDate'];
  ...
  ?>
        ...
        <div class="container-three">
          <a href='inbound_cyb.html' class='btn'>Go Back</a> <br> <br>
          <a href='view_inbound.php' class='btn'>View Entries</a>
        </div>
