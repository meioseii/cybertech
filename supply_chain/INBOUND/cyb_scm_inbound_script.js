function updateInfo() {
      ...
      var supplierAddress = document.getElementById("address");
      var suppContactInfo = document.getElementById("contactinfo");
      

      // Get the selected gender
      var selectedName = supplierName.value;

      // Create new options based on the selected gender
      if (selectedName === "Rejay Buta") {
        
        supplierAddress.value="Duhat Street Camella, Molino 3, Bacoor Cavite";
        
        suppContactInfo.value="0916446823";
        
      } else if (selectedName === "Daniel Mendoza") {
        
        supplierAddress.value="Santolan Street WoodState, ANABU 2, Imus Cavite";
        
        suppContactInfo.value="09218264923";
        
        }
        else if (selectedName === "Jamil Mariano") {
        
        supplierAddress.value="Bughaw Street Town&Country, Alapan 1, Imus Cavite";
