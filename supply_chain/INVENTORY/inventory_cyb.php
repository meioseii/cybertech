...
<HTML>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="table_inventory.css">
...
if ($result->num_rows > 0) {
    ...
    echo "<td> 
        <a href='inventory_cyb.php?id=". $row['id'] ."' class='delbutton' > Delete </a> </td>";
        echo "</tr>";
  ...
  ?>
        ...
        <div class="container-three">
          <a href='insert_inventory.html' class="btn">ADD ITEM</a>
          </div>
